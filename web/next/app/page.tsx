  ...
  return (
    <main className="app-shell">
      <header className="page-header">
        <p className="page-kicker">Bienvenue dans TaskForge</p>
        <h1 className="page-title">La to-do list que tu forges de tes mains.</h1>
        ...
        <div className="card">
          ...
          <div className="max-w-xl">
            ...
            <p className="mb-5 text-sm md:text-[0.95rem] text-slate-200/90">
              Tu notes ce que tu dois faire, tu le glisses dans &quot;À faire&quot;,
              &quot;En cours&quot; ou &quot;Terminées&quot;, et tu coches quand c&apos;est plié.
              Pas de comptes à créer, pas de menus compliqués&nbsp;: juste toi
              et ta liste.
            </p>
            ...
            <div className="flex flex-wrap items-center gap-4">
              ...
              <p className="text-xs md:text-sm text-slate-300/80">
                Curieux de la technique ? Jette un œil aux pages SSR / SSG dans le menu.
              </p>
            </div>
          </div>
        </div>
          ...
          <ol className="feature-list">
            <li className="feature-item">
              ...
              <p>
                ...
                tâche, un truc à ne pas oublier&nbsp;: tu l&apos;ajoutes en quelques
                secondes et tu passes à autre chose.
              </p>
            </li>
            <li className="feature-item">
              ...
              <p>
                ...
                &quot;À faire / En cours / Terminées&quot; te montre l&apos;avancement en un
                coup d&apos;œil, que ce soit pour le taf, les études ou perso.
              </p>
            </li>
            <li className="feature-item">
